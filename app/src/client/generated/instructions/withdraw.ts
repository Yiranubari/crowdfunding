...
>(
  input: WithdrawInput<TAccountCampaign, TAccountUser>,
  config?: { programAddress?: TProgramAddress },
): WithdrawInstruction<TProgramAddress, TAccountCampaign, TAccountUser> {
  // Program address.
  ...
  return Object.freeze({
    ...
    programAddress,
  } as WithdrawInstruction<TProgramAddress, TAccountCampaign, TAccountUser>);
}
...
>(
  ...
  return {
    ...
    accounts: { campaign: getNextAccount(), user: getNextAccount() },
